...
export default function Card() {
  return (
    <div className="text-xl border-[1px] border-[#E0E0E0] rounded-lg bg-white w-[353px] h-[326px]  p-4 transition-shadow duration-400 hover:shadow-lg hover:shadow-gray-400">
